...
exports.getCustomerDetailsById = exports.mockCustomerDetails = void 0;
exports.mockCustomerDetails = [
  {
    customerId: "3678905",
    appliances: [
      {
...
function getCustomerDetailsById(customerId) {
  try {
    for (const customer of exports.mockCustomerDetails) {
...
//# sourceMappingURL=customerMockValue.js.map
